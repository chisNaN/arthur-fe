...
<p>Après que des ex-conjoints, par exemple, aient batifolé chacun de leur côté (expériences permettant points de références, comparaison), ils pourraient décider de renouer une ancienne relation. On est assez éloigné d'un engagement suite à une longue expérience de vie en commune au préalable.</p>`;
...
<p>Je m'intéresserais plus aux choses qu'aux gens.</p><p>Sur mon épitaphe: 'I climbed the tree to see the world.'</p><p>Au fond je suis marié depuis mes 15-16 ans environ: au Rach 3!</p>
